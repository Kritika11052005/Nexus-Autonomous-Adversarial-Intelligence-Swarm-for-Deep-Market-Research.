...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen bg-bg-base text-text-primary flex flex-col items-center justify-center p-6 overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-[20%] left-[30%] w-96 h-96 rounded-full bg-violet-800/10 blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] right-[30%] w-96 h-96 rounded-full bg-cyan-800/10 blur-[120px] pointer-events-none"></div>
      ...
      <div className="relative w-full max-w-md border border-border-subtle bg-bg-surface p-8 rounded-2xl shadow-[0_0_24px_rgba(0,255,209,0.03)] z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary text-sm">
            Join the adversarial intelligence swarm.
          </p>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5">
          ...
          >
            {loading ? "INITIALIZING SECURE SESSION..." : "REGISTER USER"}
        ...
        <div className="text-center mt-6 pt-4 border-t border-border-subtle/50">
          <span className="text-text-secondary text-xs">Already have an account? </span>
          <Link
            href="/login"
