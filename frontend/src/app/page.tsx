        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-1 text-center md:text-left">
            ...
            <span className="font-sans text-[11px] text-text-secondary">
              made by <span className="text-accent-cyan font-semibold">Kritika Benjwal</span> & <span className="text-accent-cyan font-semibold">Sarthak Gupta</span>
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <span className="font-mono text-[9px] text-text-muted uppercase tracking-widest">Kritika:</span>
              <div className="flex items-center gap-2">
                <a
                  href="https://github.com/Kritika11052005"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-lg border border-white/5 bg-white/4 flex items-center justify-center text-text-secondary hover:text-accent-cyan hover:border-accent-cyan/30 hover:scale-105 transition-all cursor-pointer"
                  aria-label="Kritika's GitHub"
                >
            ...
            {/* Sarthak */}
            <div className="flex items-center gap-3">
              <span className="font-mono text-[9px] text-text-muted uppercase tracking-widest">Sarthak:</span>
              <div className="flex items-center gap-2">
                <a
